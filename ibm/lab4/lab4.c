...
// arm-linux-gnueabi-gcc lab4.c -lm
// arm-linux-gnueabi-gcc -O3 lab2.c -o lab2.bin -S -o asm.s 
// arm-linux-gnueabi-gcc -O3 lab2.c -S -o asm.s --- правильно
// arm-linux-gnueabihf-gcc -O3 lab2.c -S -o asm.s --- правильно
