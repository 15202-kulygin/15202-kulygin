...
*/
	...
	A a;
	A a2 = std::move(a); // ничего не передвигает, на самом деле это каст к rvalue ссылке -> вызывается move-constructor
	//a2 is ok, a is not valid
	// надо обработать, чтобы корректно удалить
