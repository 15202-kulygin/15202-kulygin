...
void FeildWidget::SaveToFile(std::string file_name)
{
    ...
    int currentHeight = feild->getHeight();
    int currentLength = feild->getWidth();
    file << "HEIGHT= " << currentHeight << std::endl;
    file << "WIDTH= " << currentLength << std::endl;
    file << "FEILD:" << std::endl;
